...
int main()
{
	...
	const int PRINCIPAL_WIDTH = 400;
	const int PRINCIPAL_HEIGHT = 400;
	const int SECUNDARIA_WIDTH = 400;
	...
	// VALLA PRINCIPAL
	cimg_library::CImg<unsigned char> img_principal("imgs/image2.jpg");
